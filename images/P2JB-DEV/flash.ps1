...
$img = Join-Path $PSScriptRoot "P2JB-DEV-merged.bin"
if (-not (Test-Path $img)) {
    Write-Host "downloading P2JB-DEV-merged.bin from Releases ..." -ForegroundColor Cyan
    Invoke-WebRequest -Uri "https://github.com/soniciso1/ESP32-S3-Hosts/releases/download/v1.0/P2JB-DEV-merged.bin" -OutFile $img
}
