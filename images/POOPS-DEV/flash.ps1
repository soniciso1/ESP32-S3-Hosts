# Flash POOPS-DEV to a 16 MB ESP32-S3. One merged image at 0x0.
#
...
$img = Join-Path $PSScriptRoot "POOPS-DEV-merged.bin"
if (-not (Test-Path $img)) {
    Write-Host "downloading POOPS-DEV-merged.bin from Releases ..." -ForegroundColor Cyan
    Invoke-WebRequest -Uri "https://github.com/soniciso1/ESP32-S3-Hosts/releases/download/v1.0/POOPS-DEV-merged.bin" -OutFile $img
}
...
Write-Host "Flashing POOPS-DEV-merged.bin to $Port ..." -ForegroundColor Cyan
...
Write-Host '"PS5-POOPS-DEV" on the PS5 and open Manuals.' -ForegroundColor Yellow
